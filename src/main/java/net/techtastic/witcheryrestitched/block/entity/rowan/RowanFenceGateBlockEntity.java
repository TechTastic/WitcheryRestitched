...
public class RowanFenceGateBlockEntity extends FenceGateBlockEntity {

    public RowanFenceGateBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.ROWAN_FENCE_GATE_BLOCK_ENTITY, pos, state);
    }
}
