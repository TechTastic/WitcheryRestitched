...
import net.techtastic.witcheryrestitched.block.custom.withentity.DoorBlockWithEntity;
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (stack.isOf(ModItems.KEY)) {
            ...
            if (nbt.contains("witcheryrestitched:keyUuid")) {
                if (world.getBlockState(pos.up()).getBlock() instanceof KeyedDoor) {
                ...
                } else if (world.getBlockState(pos.down()).getBlock() instanceof KeyedDoor){
                    DoorBlockEntity door = (DoorBlockEntity) world.getBlockEntity(pos.down());
