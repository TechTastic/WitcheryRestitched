...
public class HawthornFenceGateBlockEntity extends FenceGateBlockEntity {

    public HawthornFenceGateBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.HAWTHORN_FENCE_GATE_BLOCK_ENTITY, pos, state);
    }
}
